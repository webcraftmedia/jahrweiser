...
<template>
  ...
  >
    <div
      class="max-w-screen-2xl mx-auto flex items-center justify-center md:justify-between text-sm text-navy/60 dark:text-ivory/60 px-2 2xl:px-0"
    >
      ...
      >
        ...
        <!-- eslint-enable @intlify/vue-i18n/no-raw-text -->
        <button
          class="flex items-center justify-center text-navy/60 dark:text-ivory/60 hover:text-navy dark:hover:text-ivory transition-colors p-2 md:p-1.5 bg-navy/10 dark:bg-ivory/10 rounded-lg"
