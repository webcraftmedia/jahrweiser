...
| `GET /api/map/boundaries`  | Bundesland and Kreis borders inside a rectangle, by level                      | session                           |
...
| `server/assets/map/boundaries.json` | ~18.000 Bundesland and Kreis border arcs with their boxes, plus 415 names |
